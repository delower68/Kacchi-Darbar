      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        >
          <img 
            ...
            className="w-12 h-12 rounded-full border border-primary-green/30 p-0.5"
          />
            ...
            <div className="flex flex-col p-8 gap-6">
              {navLinks.map((link, idx) => (
                <motion.a
                  ...
                  className="text-2xl font-black text-white hover:text-primary-green transition-colors uppercase tracking-widest flex items-center justify-between group"
                >
                  {link.name}
